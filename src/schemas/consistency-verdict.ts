...
export const ConsistencyVerdictSchema = z.object({
  ...
  score: z.number().min(0).max(10).describe('0-10: how faithfully the candidate reproduces the canonical product (material, colour, finish, distinguishing features, visibility)'),
